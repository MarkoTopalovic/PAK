...
C==========================================================================
C==========================================================================
      SUBROUTINE VULTABF (TABF,ITFMAX)
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
      COMMON /VREPER/ NPER,NTABFT
      COMMON /ULAZNI/ IULAZ,IIZLAZ,IPAKT
      COMMON /SRPSKI/ ISRPS
...
C==========================================================================
C==========================================================================
      SUBROUTINE VTIMFUN(TABF,SILAF,UVREME,IBRT,IFUN)
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
      COMMON /VREPER/ NPER,NTABFT
      COMMON /ULAZNI/ IULAZ,IIZLAZ,IPAKT
...
C==========================================================================
      SUBROUTINE VMINV(A,N,D,L,M)
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
C
CS    INVERTOVANJE MATRICE
CE    INVERT OF MATRIX
CS    UPOTREBA
CS    CALL VMINV(A,N,D,L,M)
...
C==========================================================================
C==========================================================================
      SUBROUTINE VPREB(TT21,TT1,NBREL)
      USE NODES
      USE ELEMENTS
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
...
C==========================================================================
C==========================================================================
      SUBROUTINE VSSTAM(TT1,CORD,ID,NPROM)
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
...
C==========================================================================
C==========================================================================
      SUBROUTINE VOPTIM1(TT1,SILE,NEL,ID,NZAD,ZADVRE,NGPSIL,
...
C
      CALL VRACUN(TT1,SILE,NEL,ID,NZAD,ZADVRE,NGPSIL,
...
C==========================================================================
C==========================================================================
      SUBROUTINE VPRKONT1(TT1,ID,UBRZ,CORD,NZAD,IOSA,IVECT,ZADVRE,KOJK)
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
      COMMON /ULAZNI/ IULAZ,IIZLAZ,IPAKT
      COMMON /NUMNPT/ NUMZAD,NPT,NDIM,MAXSIL,JEDN,NWK,NET
      COMMON /PRIKAZ/ INDSC,IZPOT
...
C==========================================================================
C==========================================================================
      SUBROUTINE VPRKONT1c(TT1,ID,UBRZ,CORD,NZAD,IOSA,IVECT,ZADVRE,KOJK)
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
      COMMON /ULAZNI/ IULAZ,IIZLAZ,IPAKT
      COMMON /NUMNPT/ NUMZAD,NPT,NDIM,MAXSIL,JEDN,NWK,NET
      DIMENSION TT1(*),ID(1,*),UBRZ(*),CORD(3,*),NZAD(3,*),IVECT(*)
...
1000    FORMAT('CVOR=',I5,5X,'FLUX=',D13.5)          
       ...
       END
C==========================================================================
      SUBROUTINE VCURI1(CORD,ALEVO,SILE,MAXA,TT1,ID,ICUR)
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
      COMMON /NUMNPT/ NUMZAD,NPT,NDIM,MAXSIL,JEDN,NWK,NET
      COMMON /ULAZNI/ IULAZ,IIZLAZ,IPAKT
      COMMON /DODAT/ NDIMM
...
C==========================================================================
C==========================================================================
      SUBROUTINE VCKONV1(ICUR,TT1,CORD,ID,KONVER,UBRZ)
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
...
C==========================================================================
C==========================================================================
      SUBROUTINE VINIDOK(NZAD,ICUR,CORD)
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
...
C          IDOKL=0
     ...
     *WRITE(IIZLAZ,*) 'NODE         VERTICAL(Y/Z)-COORDINATE'
         ...
         ENDDO
C       CALL VIWRR(ICUR,MAXCUR,'ICUR=')
 1000   FORMAT (3I6,F10.3)
      
      END
C==========================================================================
C=========================================================================
      SUBROUTINE VPROCEN(RS2,PR,FAK,NEL,NBREL,CORD) 
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
...
C==========================================================================
C=========================================================================
      SUBROUTINE VPSKEFN(SKEF,SKEFN,NDIMEL)
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
      COMMON /NDESUK/ NDES,IDPRIT,IFORM
...
C======================================================================
      SUBROUTINE VDELJIV(IBROJ,IDELI,IND)
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
C
C ......................................................................
C .
...
C======================================================================
      SUBROUTINE VCHECKJ(NELG,NBREL,CORDG,CORD,IND)
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
...
C
      ...
      END
C=======================================================================
      SUBROUTINE VULTABFPT(NTAV,FN,NBR,MAXT,IBR,IMAX,ITMAX,
     1 TFMX,TMAX,IND)
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
      CHARACTER*80 ACOZ
CE READ INPUT DATA FOR FUNCTIONS GIVEN AS TABLE
 ...
 1001 FORMAT(2F10.3)
      END
C=======================================================================
      SUBROUTINE VBOFANG(Y1,Y2,TW1,TW2,TM,TS,C,Y)
      USE PREDISCRIBED
!       INTEGER*8 
     ...
     1(-Alpha*Y1))*exp(-Alpha*Y2)-(1-exp(-Alpha*Y2))*exp(-Alpha*Y1))
      ...
      END
C=======================================================================
      SUBROUTINE VLININTGV(Y1,Y2,TW1,TW2,TM,IND,Y)
      USE PREDISCRIBED
...
!         WRITE(3,*) "Y1,Y2,TW1,TW2,TM,IND,Y",Y1,Y2,TW1,TW2,TM,IND,Y
      ...
      END
C=======================================================================
      SUBROUTINE VTEMP_DEMPENDANCE(TM,TS,C)
      USE PREDISCRIBED
!       INTEGER*8 
      ...
      END
C=======================================================================
      SUBROUTINE VPRED_INTERP(I,INTERPAXIS,NUMAXISPOINTS,INTAXISPOINT,
...
!          WRITE(3,*) "INTAXISPOINT(2,1)",INTAXISPOINT(2,1)
         CALL VTIMFUN(TABF,FK1,VVREME,ITFMAX(INTAXISPOINT(2,1))
     1                                         ,INTAXISPOINT(2,1))
!          WRITE(3,*) "FK1",FK1
        CASE (2)
!          WRITE(3,*) "INTAXISPOINT(2,",NSEG,")",INTAXISPOINT(2,NSEG)
!          WRITE(3,*) "INTAXISPOINT(2,",NSEG+1,")",INTAXISPOINT(2,NSEG+1)
         CALL VTIMFUN(TABF,Fx1,VVREME,ITFMAX(INTAXISPOINT(2,NSEG))
     1                                      ,INTAXISPOINT(2,NSEG))
         CALL VTIMFUN(TABF,Fx2,VVREME,ITFMAX(INTAXISPOINT(2,NSEG+1))
...
!          WRITE(3,*) "FK1,Fx1,Fx2",FK1,Fx1,Fx2
        CASE (3)
!          WRITE(3,*) "INTAXISPOINT(2,1)",INTAXISPOINT(2,1)
         CALL VTIMFUN(TABF,FK1,VVREME,ITFMAX(INTAXISPOINT(2,
...
!           WRITE(3,*) "FK1,Fx1,Fx2",FK1,Fx1,Fx2
      ...
      END
C=======================================================================
      SUBROUTINE VPREDF_INTERP(I,NZAD,CORD,FK1,IND)
...
!          CALL VTIMFUN(TABF,Fx2,VVREME,ITFMAX(INTAXISPOINT(2,2))
!      1                                      ,INTAXISPOINT(2,2))
         Fkf1=Fakt/(y1-y2)
