...
C
      ...
      COMMON /TRAKEJ/ IULAZ,IZLAZ,IELEM,ISILE,IRTDT,IFTDT,ILISK,ILISE,
     1                ILIMC,ILDLT,IGRAF,IDINA,IPOME,IPRIT,LDUZI
      COMMON /VREMEN/ IVREM(4,6),IDATE(3,6),ITRANS(6),IWR(6)
      COMMON /VREMEH/ BUF(4)
      COMMON /MASINA/ INDPC,ICRTA
      COMMON /SRPSKI/ ISRPS
...
C      IF(NULAZ.GE.0.OR.NBLPR.GE.0) THEN
        IF(ISRPS.EQ.0)THEN
            TEXT(1)='POCETAK UCITAVANJA ULAZNIH PODATAKA ............ '
            TEXT(2)='POCETAK IZVRSAVANJA PO PERIODIMA ............... '
            TEXT(3)='POCETAK IZRACUNAVANJA SOPSTVENIH VREDNOSTI ..... '
            TEXT(4)='ZAVRSETAK PRORACUNA ............................ '
            TEXT(5)='POCETAK TACKANJA ............................... '
            TEXT(6)='ZAVRSETAK TACKANJA ............................. '
        ENDIF
        IF(ISRPS.EQ.1)THEN
            TEXT(1)='TIME AT THE START OF READING OF INPUT DATA ..... '
            TEXT(2)='TIME AT THE START OF FORMING THE MATRICES ...... '
            TEXT(3)='TIME AT THE START OF EIGEN VALUE SOLUTION ...... '
            TEXT(4)='END OF JOB ..................................... '
            TEXT(5)='DOTTING STARTED ................................ '
            TEXT(6)='DOTTING FINISHED ............................... '
        ENDIF
        IF(KV.GT.4) THEN
      WRITE(*,5000)TEXT(KV),(IVREM(I,KV),I=1,4),(IDATE(I,KV),I=1,3)
      WRITE(IZLAZ,5000)TEXT(KV),(IVREM(I,KV),I=1,4),(IDATE(I,KV),I=1,3)
        ENDIF
        IF(KV.NE.4) RETURN
        ITRANS(1) = 1
        ITRANS(2) = 5
        ...
        ENDIF
           ...
           L=ITRANS(K)
             IF(IWR(K).EQ.1)
     +WRITE(IZLAZ,5000)TEXT(L),(IVREM(I,L),I=1,4),(IDATE(I,L),I=1,3)
   10      CONTINUE
...
C-----------------------------------------------------------------------
 ...
 6001 FORMAT(5X,
     ...
     2 I2,':',I2,':',I2,'.',I3,3X,I2,'/',I2,'/',I4//)
 6002 FORMAT(5X,
     3'TIME AT THE START OF FORMING THE MATRICES ...... ',
     3 I2,':',I2,':',I2,'.',I3,3X,I2,'/',I2,'/',I4//)
 6003 FORMAT(5X,
     4'TIME AT THE START OF EIGEN VALUE SOLUTION ...... ',
     4 I2,':',I2,':',I2,'.',I3,3X,I2,'/',I2,'/',I4//)
 6004 FORMAT(5X,
     5'END OF JOB ..................................... ',
     5 I2,':',I2,':',I2,'.',I3,3X,I2,'/',I2,'/',I4///)
