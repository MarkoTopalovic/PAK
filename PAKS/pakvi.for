C======================================================================
      SUBROUTINE VISOHIP(X,Y,IPOINT,Y0,XX,YY,ZZ,AKK)
...
C      NBRF=44
	...
	IF (INDJED.EQ.0) THEN
	  NGL=1
        CALL VISJEDN(X,Y,Y0,IPOINT,NBRF,NGL)
...
C==========================================================================
C==========================================================================
      SUBROUTINE VISJEDN(X,Y,Y0,IPOINT,NBRF,NGL)
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
...
C======================================================================
      SUBROUTINE VNGXYZ(NEL,NBREL,H,CORD,XX,YY,ZZ)
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
      COMMON /DODAT/ NDIMM
