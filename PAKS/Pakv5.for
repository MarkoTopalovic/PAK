C==========================================================================
      SUBROUTINE VULKO3D(AK,NUMMAT,INDPK)
...
C=======================================================================
      SUBROUTINE VULAZT4(POVSIL,NEL,NGPSIL,MAXSIL,NDIM)
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
...
C
 ...
 1017 FORMAT(I20,3I10,2F10.3)
      END
C==========================================================================
      SUBROUTINE VULA3D4(POVSIL,NGPSIL,MAXSIL,ISNUMER,NET)
      USE NODES
      USE ELEMENTS
      USE PREDISCRIBED
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
...
!  1025 FORMAT(10X,9I10,4F10.3,I10)
 ...
 6101 FORMAT(//' ERROR IN INPUT DATA ABOUT PRESCRIBE POT/TEM'/
     1' ELEM',I10,' NOT EXIST'I10 /' PROGRAM STOP - PAKV5 - ULA3D4'//)
      END
C==========================================================================
      SUBROUTINE VULA3D4TOK(ISNUMER,NET)
      USE NODES
      USE ELEMENTS
      USE PREDISCRIBED
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
...
! 	  if(npov.eq.0) stop "The surface is not defined on element"
 ...
 6100 FORMAT(//' ERROR IN INPUT DATA ABOUT PRESCRIBE POT/TEM'/
     1' NODE',I10,' NOT EXIST'//' PROGRAM STOP - PAK051 - FSPOLJ'//)
      END
C==========================================================================
      SUBROUTINE VULA3D4R(ISNUMER,NET)
      USE NODES
      USE ELEMENTS
      USE PREDISCRIBED
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
...
!       ENDIF
 ...
 1017 FORMAT(3I10,F10.4)
      END
C==========================================================================
      SUBROUTINE VULKONT(KONT,ISNUMER,NET)
      USE NODES
      USE ELEMENTS
      USE KONTURE
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
...
C==========================================================================
C     SUBROUTINE VNEWID(ID,JEDN,NPT)
...
C
      IND=0
      IF(STAT.EQ.'OLD') CALL VBRIS (IME,18,IND)
...
!       IMEDJ(5) = ZSILE//'5'
   ...
   21     STAT='NEW'
     ...
     1 ACCESS='SEQUENTIAL')
                         ENDIF
         IND=0
         IF(STAT.EQ.'OLD') CALL VBRISZST (IME,IFILE,IND)
   ...
   20  STAT='NEW'
     ...
     1 ACCESS='SEQUENTIAL')
                        ENDIF
         IND=0
         IF(STAT.EQ.'OLD') CALL VBRISZST (IME,25,IND)
         IF(IND.EQ.1)GO TO 20
         IF(IND.EQ.2)GO TO 15
       ENDIF
   30  FORMAT (I1)
...
!                         ENDIF
!          IND=0
!          IF(STAT.EQ.'OLD') CALL VBRISZST (IME,19,IND)
!          IF(IND.EQ.1)GO TO 20
!          IF(IND.EQ.2)GO TO 15
!        ENDIF
   30  FORMAT (I1)
...
C
      IND=0
      IF(STAT.EQ.'OLD') CALL VBRIS (IME,49,IND)
      IF(IND.EQ.1)GO TO 20
      IF(IND.EQ.2)GO TO 15
      RETURN
      END
...
C======================================================================
      SUBROUTINE VTGRAFC(CORD,NPT,II)
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
 ...
 1000 FORMAT(4I10,3E13.5)
   10 CONTINUE
      ...
      END
C=======================================================================
      SUBROUTINE VTGRAFE(NEL,NBR2,NET,NGE,II)
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
      COMMON /ULAZNI/ IULAZ,IIZLAZ,IPAKT
      COMMON /MATER/ NUMMAT
...
C=======================================================================
      SUBROUTINE VTGRAF3(NEL,NBR2,NET,NGE,II)
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
      COMMON /ULAZNI/ IULAZ,IIZLAZ,IPAKT
      COMMON /MATER/ NUMMAT
      COMMON /TIPEL/ NP2DMX
...
C=======================================================================
      SUBROUTINE VSTAGP1(RTH,ID,NASLOV,VREME,KOR,NDT,NP,II,IND,NET,NEL,
...
C=======================================================================
C=======================================================================
      SUBROUTINE VSTAG3D(RTH,NASLOV,VREME,KOR,NDT,NP,II,IND,NET,
...
C=======================================================================
C=======================================================================
      SUBROUTINE VULAZT5(KONSIL,SILKON,KONS)
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
      COMMON /ULAZNI/ IULAZ,IIZLAZ,IPAKT
      CHARACTER*250 ACOZ
...
C=======================================================================
      SUBROUTINE VRESEN_(A,V,MAXA,NN,NWK,KKK)
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
C
      COMMON /SRPSKI/ ISRPS
      COMMON /ULAZNI/ IULAZ,IIZLAZ,IPAKT
...
C        CALL VIWRR(MAXA,NN,'JDIA')
C        CALL VWRR(V,NN,'V   ')
C        CALL VWRR(A,NWK,'AA  ')
C
...
C=======================================================================
C=======================================================================
      SUBROUTINE VMATSTE(SK,MAXA,F,SKE,FE,LM,NCV,INDSK)
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
C
...
C=======================================================================
C=======================================================================
      SUBROUTINE VSPAKDE(F,FE,LM,NCV)
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
C
CS  PAKOVANJE MATRICA I VEKTORA ELEMENATA U MATRICE I VEKTORE SISTEMA
CE  INSERTING ELEMENT MATRIXES AND VECTORS
...
C=======================================================================
C=======================================================================
      SUBROUTINE VDODAEL(NEL,ID,CORD,NELG,CORDG,NNOVI)
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
      COMMON /ULAZNI/ IULAZ,IIZLAZ,IPAKT
      COMMON /DODAT/ NDIMM
...
C
	...
	WRITE(IIZLAZ,*)'DODATNI ELEMENTI'
      ...
      DO 200 NBREL=1,NET
        ...
        K=0
        CALL VKRITY(NEL,CORD,NBREL,Y1,Y2,NDIM)
       DO J=1,NDIM
       NODE=NEL(J,NBREL)
...
C KRAJ PETLJE PO ELEMENTIMA
 200    CONTINUE     
         ...
         CALL VMERGE(NELG,CORDG,NPTGL,NETGL,NNOVI)
...
C=======================================================================
C=======================================================================
      SUBROUTINE VDODEL1(NEL,ID,CORD,NELG,CORDG,NNOVI)
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
      COMMON /ULAZNI/ IULAZ,IIZLAZ,IPAKT
      COMMON /DODAT/ NDIMM
      COMMON /NUMNPT/ NUMZAD,NPT,NDIM,MAXSIL,JEDN,NWK,NET
C
	...
	WRITE(IIZLAZ,*)'DODATNI ELEMENTI DOLE'
      ...
      DO 200 NBREL=1,NMAX
        ...
        IF (NEL(NDIMM,NBREL).EQ.0) GOTO 200
        K=0
        CALL VKRITY1(NEL,CORD,NBREL,NDIM,NIZ,K,IBRSL,ILOK)
         ...
         DO IDUB=1,IDUBIN
          NETGL=NETGL+1
           ...
           ENDDO
            ...
            NELG(8,NETGL-NET)=NPTGL-1
            NELG(9,NETGL-NET)=NEL(9,NBREL)
            CALL VCHECKJ(NELG,NETGL-NET,CORDG,CORD,0)
C             WRITE(IIZLAZ,100) NETGL-NET,(NELG(I,NETGL-NET),I=1,9)        
         ENDDO
        ENDIF
 ...
 200    CONTINUE     
	...
	WRITE(IIZLAZ,*)'DODATNI ELEMENTI GORE'
      ...
      DO 201 NBREL=1,NMAX
        ...
        K=0
        CALL VKRITY2(NEL,CORD,NBREL,NDIM,NIZ,K,IBRSL,ILOK)
        IF (K.EQ.4) THEN
          WRITE(IIZLAZ,*) IBRSL,ILOK
         ISTR=1
...
C KRAJ PETLJE PO ELEMENTIMA
 201    CONTINUE     
         ...
         DO I=1,NETGL-NET
            CALL VCHECKJ(NELG,I,CORDG,CORD,1)
         ENDDO
...
C=======================================================================
C=======================================================================
      SUBROUTINE VMERGE(NELG,CORDG,NPTGL,NETGL,NNOVI)
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
      COMMON /ULAZNI/ IULAZ,IIZLAZ,IPAKT
	COMMON /NUMNPT/ NUMZAD,NPT,NDIM,MAXSIL,JEDN,NWK,NET
      COMMON /DODAT/ NDIMM
...
C=======================================================================
C=======================================================================
      SUBROUTINE VKRITY(NEL,CORD,NBREL,Y1,Y2,NDIM)
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
      COMMON /DODAT/ NDIMM
...
C=======================================================================
      SUBROUTINE VKRITY1(NEL,CORD,NBREL,NDIM,NIZ,INDK,IBRSL,ILOK)
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
      COMMON /DODAT/ NDIMM
...
C       CALL VSMERN(NIZ,CORD,PX,PY,PZ)
      ENDIF
...
C=======================================================================
      SUBROUTINE VKRITY2(NEL,CORD,NBREL,NDIM,NIZ,INDK,IBRSL,ILOK)
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
      COMMON /DODAT/ NDIMM
...
C=======================================================================
C=======================================================================
      SUBROUTINE VSTAZP(NZAD,NASLOV,KOR)
C=======================================================================
...
C==========================================================================
      SUBROUTINE VSMERN(NIZ,CORD,PX,PY,PZ)
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
      ...
      END
C=======================================================================
      SUBROUTINE VIZBACI(TT1,CORD,ID,NPT,NEL,NET,IOSA,NDIM,IIZLAZ)
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
      COMMON /DODAT/ NDIMM
      COMMON /PRIKAZ/ INDSC,IZPOT
      DIMENSION NEL(NDIMM,*),CORD(3,*)
...
C=======================================================================
      SUBROUTINE VIZBACIT(TT1,CORD,ID,NPT,NEL,NET,NDIM,IIZLAZ)
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
      COMMON /DODAT/ NDIMM
      DIMENSION NEL(NDIMM,*),CORD(3,*)
      DIMENSION TT1(*),ID(1,*)
