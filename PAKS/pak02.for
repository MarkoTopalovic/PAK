...
C
      ...
      CALL ISPITA(ACOZ)
      KART(2)=KARTIC
c      READ(IULAZ,1010) INDFOR,ind56,IDJERDAP,IOPIT
      READ(IULAZ,1010) INDFOR,ind56,IDJERDAP,IOPIT,ISPRESEK,IRPRIT
      write(*,*)'ind56=',ind56
      IF(INDFOR.EQ.0) INDFOR = 2
C      ISPRESEK=0
C      IRPRIT=0
C      IF(IDJERDAP.NE.0) THEN
C      ISPRESEK=1
C      IRPRIT=1
C      ENDIF
C
...
C
     ...
     1WRITE(IZLAZ,6005) KART(2)
      IF(ISRPS.EQ.0)
     1WRITE(IZLAZ,2020) INDFOR,IND56,IDJERDAP,IOPIT,ISPRESEK,IRPRIT
      IF(ISRPS.EQ.1)
     1WRITE(IZLAZ,6020) INDFOR,IND56,IDJERDAP,IOPIT,ISPRESEK,IRPRIT
C
      IF(ISRPS.EQ.0)
...
C-----------------------------------------------------------------------
 ...
 2020 FORMAT(
     ...
     116X,'EQ.0; I5'/
     116X,'EQ.1; I10'///
     111X,'SEGMENT DJERDAPA ZA KOJI SE VRSI PRORACUN ... IDJERDAP =',I5/
     116X,'EQ.0; NE'/
     116X,'EQ.1-14; LAMELE L1-L14'/
     116X,'EQ.15-17; SEKCIJE SIII-SI'/
     116X,'EQ.14; MONTAZNI BLOK MB'///
     111X,'INDIKATOR OPITA ZA DJERDAP ..................... IOPIT =',I5/
     116X,'EQ.0; NE'/
     116X,'EQ.1; BS'/
     116X,'EQ.2; SS'/
     116X,'EQ.3; VJ'/
     116X,'EQ.4; HJ'///
     111X,'INDIKATOR STAMPANJA PO PRESECIMA DJERDAPA ... ISPRESEK =',I5/
     116X,'EQ.0; NE'/
     116X,'EQ.1; STAMPA PO PRESECIMA SEGMENATA DJERDAPA'///
     111X,'INDIKATOR RACUNANJA PRITISKA ZA DJERDAP ....... IRPRIT =',I5/
     116X,'EQ.0; NE'/
     116X,'EQ.1; RAČUNA ISPOD NIVOA GORNJE I DONJE VODE'///)
...
C-----------------------------------------------------------------------
 ...
 6020 FORMAT(
     ...
     116X,'EQ.0; I5'/
     116X,'EQ.1; I10'///
     111X,'SEGMENT OF DJERDAP TO BE ANALYZED ........... IDJERDAP =',I5/
     116X,'EQ.0; NO'/
     116X,'EQ.1-14; LAMELLA L1-L14'/
     116X,'EQ.15-17; SECTION SIII-SI'/
     116X,'EQ.14; REAR BLOCK MB'///
     111X,'INDICATOR OF EXPERIMENT FOR DJERDAP ............ IOPIT =',I5/
     116X,'EQ.0; NO'/
     116X,'EQ.1; BS'/
     116X,'EQ.2; SS'/
     116X,'EQ.3; VJ'/
     116X,'EQ.4; HJ'///
     111X,'PRINT CROSS-SECTIONS RESULTS OF DJERDAP ..... ISPRESEK =',I5/
     116X,'EQ.0; NO'/
     116X,'EQ.1; PRINT IN CROSS-SECTIONS OF SEGMENTS'///
     111X,'INDICATOR FOR HYDRO-PRESSURE FOR DJERDAP ...... IRPRIT =',I5/
     116X,'EQ.0; NO'/
     116X,'EQ.1; PRESSURE UNDER LEVEL OF UPPER AND DOWN WATHER'///)
 6030 FORMAT(6X,
